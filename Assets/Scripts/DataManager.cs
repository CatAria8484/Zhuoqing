...
internal class DataManager : MonoBehaviour
{
    ...
    {
        FileStream file = new FileStream(Application.dataPath + "/userdata.dat", FileMode.Create);
    ...
    internal void LoadUserData()
    {
        try
        {
            FileStream file = new FileStream(Application.dataPath + "/userdata.dat", FileMode.Open);
            BinaryFormatter binaryFormatter = new BinaryFormatter();
